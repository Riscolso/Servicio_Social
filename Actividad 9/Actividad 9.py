...
def escribirEnBD(preguntas):
    ...
    miConexion = mysql.connector.connect( host='localhost', user= 'root', passwd='root', db='actividad7')
...
#-----------CARGAR PREGUNTAS DE MYSQL-----------------
#Crear una conexión con MySQL
def cargarMySQL():
    miConexion = mysql.connector.connect( host='localhost', user= 'root', passwd='root', db='actividad6' )
    #Crear una cursor, este objeto es el que permite la ejecución de instrucciones en MySQL
    cursor = miConexion.cursor()
